...
<body><font color="red">
<h1><b> ONLINE RESTURANT</b></h1></font>
<nav class="navbar navbar-default" style="font-weight: bold;  background-color: #66004d;">

  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="starting"><font color="white">E-COMMERCE</font></a>
    </div>
    <ul class="nav navbar-nav">
      ...
      <li><a href="Registerseller"><font color="white">Register Seller</font></a></li>
      <li><a href="admin"><font color="white">Admin</font></a></li>
      <li><a href="Register"><font color="white">Login</font></a></li>
